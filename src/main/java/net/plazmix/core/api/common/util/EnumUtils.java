...
public class EnumUtils {
    ...
    private static <E extends Enum<E>> Class<E> checkBitVectorable(final Class<E> enumClass) {
        ...
        Validate.isTrue(constants.length <= Long.SIZE, String.format(CANNOT_STORE_S_S_VALUES_IN_S_BITS, Integer.valueOf(constants.length), enumClass.getSimpleName(), Integer.valueOf(Long.SIZE)));
    ...
    public static <E extends Enum<E>> EnumSet<E> processBitVectors(final Class<E> enumClass, final long... values) {
        ...
        final long[] lvalues = ArrayUtils.clone(Objects.requireNonNull(values));
