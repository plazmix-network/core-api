...
public class BooleanUtils {
     ...
     * {@code false}, everything else is {@code true}.
     * </p>
     *
     * <pre>
     ...
     * {@code NullPointerException} if unboxed to a {@code boolean}.
     * </p>
     *
     * <pre>
     ...
     *
     * <p>
     * If the {@code trueValue} and {@code falseValue} are the same number then the
     * return value will be {@code true} in case {@code value} matches it.
     * </p>
     *
     * <pre>
     ...
     * {@code falseValue} and finally for the {@code nullValue}.
     * </p>
     *
     * <pre>
    ...
    /**
     * <p>
     * Converts a boolean to an int using the convention that {@code true} is
     * {@code 1} and {@code false} is {@code 0}.
     * </p>
     *
     * <pre>
    ...
    /**
     * <p>
     * Converts a boolean to an Integer using the convention that {@code true} is
     * {@code 1} and {@code false} is {@code 0}.
     * </p>
     *
     * <pre>
     ...
     * @return the result of the logical 'and' operation. That is {@code false} if
     * any of the parameters is {@code false} and {@code true} otherwise.
