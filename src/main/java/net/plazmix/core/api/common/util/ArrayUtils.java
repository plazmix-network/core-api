...
public class ArrayUtils {
     ...
     * <p>
     * The new array contains the same elements of the input array plus the given
     * element in the first position. The component type of the new array is the
     ...
     * @return A new array containing the existing elements plus the new element The
     * returned array type will be that of the input array (unless null), in
     * which case it will have the same type as the element.
     * @since 3.10
     */
     ...
     * <p>
     * The new array contains the same elements of the input array plus the given
     * element in the first positioaddFirstaddFirstaddFirstn. The component type of
     ...
     *                    {@code null}
     * @param valueToFind the value to find
     * @return a BitSet of all the the indices of the value within the array, an
     ...
     * @return a BitSet of all the indices of the value within the array, an empty
     ...
     *
     * <p>
     * This method will return all the indices of the value which fall between the
     * region defined by valueToFind - tolerance and valueToFind + tolerance, each
     * time between the nearest integers.
     * </p>
     *
     * <p>
     * This method returns an empty BitSet for a {@code null} input array.
     ...
     * @param valueToFind the value to find
     * @param startIndex  the index to start searching at
     * @return a BitSet of the indices of the value within the array, an empty
     * BitSet if not found or {@code null} array input
     * @since 3.10
     */
     ...
     *
     * <p>
     * This method will return the indices of the values which fall between the
     * region defined by valueToFind - tolerance and valueToFind + tolerance,
     * between the nearest integers.
     * </p>
     *
     * <p>
     * This method returns an empty BitSet for a {@code null} input array.
     ...
     * @return a BitSet of all the indices of the object within the array, an empty
     * BitSet if not found or {@code null} array input
     * @since 3.10
     */
    ...
    /**
     * Finds the indices of the given object in the array starting at the given
     * index.
     *
     * <p>
     * This method returns an empty BitSet for a {@code null} input array.
     ...
     * @param objectToFind the object to find, may be {@code null}
     * @param startIndex   the index to start searching at
     * @return a BitSet of all the indices of the object within the array starting
     * at the index, an empty BitSet if not found or {@code null} array
     * input
     * @since 3.10
     */
...
//-----------------------------------------------------------------------
    ...
    public static <T> T[] insert(final int index, final T[] array, final T... values) {
         ...
         *
         * By returning null when 'array' is null, we avoid returning the vararg array
         * to the caller. We also avoid relying on the type of the vararg array, by
     ...
     *
     * @param array the array to check
     * @param <T>   the datatype of the array to check, it must implement
     *              {@code Comparable}
...
//        }
     ...
     * removed from the array. {@code null} will be returned if the input array is
     * {@code null}.
     * </p>
     *
    ...
    /**
     * <p>
     * Converts the given array into a {@link Map}. Each element of the
     * array must be either a {@link Map.Entry} or an Array, containing at
     ...
     * This method returns {@code null} for a {@code null} input array.
     *
     * @param array an array whose elements are either a {@link Map.Entry}
